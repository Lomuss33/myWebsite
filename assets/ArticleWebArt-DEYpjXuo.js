const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/androidBackgroundEngine-HmTe5YFf.js","assets/three-Dyw0HQ4s.js","assets/hourglassEngine-G8I2lkhm.js","assets/vendor-B7qg5YL7.js","assets/react-vendor-D1LkQUJD.js","assets/threeTunnelEngine-BYxOaRL9.js","assets/threePolygonDemo5Engine-J7VS_NUu.js","assets/prismFieldEngine-BQpxImA_.js","assets/soupShaderEngine-BVaccG7j.js","assets/tardisWormholeEngine-Czkyopnk.js"])))=>i.map(i=>d[i]);
import{c as Pe,g as we,A as ue,r as B}from"./index-CHO_2AuX.js";import{r as c,j as b}from"./react-vendor-D1LkQUJD.js";import"./swiper-BJPGAhIX.js";/* empty css              */import"./bootstrap-1mmB_bvA.js";import"./vendor-B7qg5YL7.js";const ke=`<svg width="100%" height="100%" viewBox="0 0 750 500" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" xml:space="preserve" xmlns:serif="http://www.serif.com/" style="fill-rule:evenodd;clip-rule:evenodd;stroke-linejoin:round;stroke-miterlimit:2;">
...
`;function $(m,{timeoutMs:p=1200}={}){if(typeof window>"u")return m(),()=>{};if("requestIdleCallback"in window){const u=window.requestIdleCallback(()=>m(),{timeout:p});return()=>window.cancelIdleCallback(u)}const R=window.setTimeout(()=>m(),0);return()=>window.clearTimeout(R)}function de(m){var a,C,M,P;if(!m)return{width:1,height:1};const p=m.getBoundingClientRect(),R=(C=(a=m.parentElement)==null?void 0:a.getBoundingClientRect)==null?void 0:C.call(a),u=(R==null?void 0:R.width)||((M=m.parentElement)==null?void 0:M.clientWidth)||1,g=(R==null?void 0:R.height)||((P=m.parentElement)==null?void 0:P.clientHeight)||u,x=Math.max(1,Math.round(p.width||m.clientWidth||u)),k=Math.max(1,Math.round(p.height||m.clientHeight||g));return{width:x,height:k}}function z(m,p,R=1){var a,C,M;const{width:u,height:g}=de(m),x=typeof window<"u"&&((C=(a=window.matchMedia)==null?void 0:a.call(window,"(pointer: coarse)"))==null?void 0:C.matches),k=Math.min(x?1:1.5,Math.max(1,Number(R)||1));if((u<32||g<32)&&typeof window<"u"){window.requestAnimationFrame(()=>{var v;const P=de(m);P.width>=32&&P.height>=32&&((v=p==null?void 0:p.setSize)==null||v.call(p,P.width,P.height,k))});return}(M=p==null?void 0:p.setSize)==null||M.call(p,u,g,k)}function fe(m,p,R="smooth"){if(typeof window>"u")return;const u=document.getElementById(m),g=document.getElementById(`scrollable-${p}`);if(!u||!g)return;const x=u.getBoundingClientRect(),k=g.getBoundingClientRect(),a=g.scrollTop+(x.top-k.top);g.scrollTo({top:Math.max(0,a),behavior:R})}const Ie=9,Ne=9,je=10,Ee=["#0000ff","#008100","#ff1300","#000083","#810500","#2a9494","#000000","#808080"],_e=["/images/web_art/patronus/bg.png","/images/web_art/patronus/layer-1.png","/images/web_art/patronus/layer-2.png","/images/web_art/patronus/layer-4.png","/images/web_art/patronus/layer-5.png","/images/web_art/patronus/layer-6.png"];function Le(m=Ie,p=Ne,R=je){const u=m*p,g=Math.max(1,Math.min(R,u-1)),x=new Set;for(;x.size<g;)x.add(Math.floor(Math.random()*u));const k=new Array(u).fill(0);for(let a=0;a<u;a++){if(x.has(a)){k[a]=-1;continue}const C=a%p,M=Math.floor(a/p);let P=0;for(let v=-1;v<=1;v++)for(let f=-1;f<=1;f++){if(f===0&&v===0)continue;const n=C+f,e=M+v;n<0||e<0||n>=p||e>=m||x.has(e*p+n)&&(P+=1)}k[a]=P}return{rows:m,cols:p,mineCount:g,mines:x,counts:k}}function Te(m,p,R,u){const g=new Set(R),x=[m];for(;x.length>0;){const k=x.pop();if(k==null||g.has(k)||u.has(k)||p.mines.has(k)||(g.add(k),p.counts[k]!==0))continue;const a=k%p.cols,C=Math.floor(k/p.cols);for(let M=-1;M<=1;M++)for(let P=-1;P<=1;P++){if(P===0&&M===0)continue;const v=a+P,f=C+M;v<0||f<0||v>=p.cols||f>=p.rows||x.push(f*p.cols+v)}}return g}function he(m,p,R){const u=m.rows*m.cols-m.mineCount;if(p.size>=u)return!0;if(R.size!==m.mineCount)return!1;for(const g of m.mines)if(!R.has(g))return!1;return!0}function De(m){return`Web art ${String(m||"tile").toLowerCase()} tile loading`}function Ae({seed:m,reduceMotion:p}){const R=JSON.stringify(Se.split("<\/script>").join("<\\/script>")),u=JSON.stringify(m);return`<!doctype html>
<html lang="en">
<head>
    <meta charset="utf-8">
...
</html>`}function be(m){return Array.isArray(m)?m.map((p,R)=>{const u=p!=null&&p.tone?` article-web-art-intro-guide-fragment-${p.tone}`:"";return b.jsx("span",{className:`article-web-art-intro-guide-fragment${u}`,children:p==null?void 0:p.text},`${(p==null?void 0:p.text)||"fragment"}-${R}`)}):m}function Mt({dataWrapper:m,id:p}){var ce;const R=Pe(),u=we(),g=`${m.uniqueId}-ambient-trace`,x=`${m.uniqueId}-ambient-hex`,k=`${m.uniqueId}-ambient-plop`,a=`${m.uniqueId}-ambient-julia`,C=`${m.uniqueId}-ambient-mines`,M=`${m.uniqueId}-ambient-rings`,P=`${m.uniqueId}-ambient-prism`,v=`${m.uniqueId}-ambient-rope`,f=`${m.uniqueId}-ambient-soup`,n=`${m.uniqueId}-ambient-tardis`,[e,r]=c.useState(null),[t,o]=c.useState(!0),s=c.useMemo(()=>m.orderedItems,[m.orderedItems]),i=c.useMemo(()=>{const N=[4,5,3,6,1,2,7,8,9,10,11,12,13,14,15],T=new Map(s.map(O=>[Number(O==null?void 0:O.id),O])),D=[];for(const O of N){const F=T.get(O);F&&D.push(F)}for(const O of s){if(!O)continue;const F=Number(O==null?void 0:O.id);N.includes(F)||D.push(O)}return D},[s]),d=c.useRef(null),[l,h]=c.useState(!1),w=c.useRef(new Set),y=c.useRef(new Map),[S,I]=c.useState(0),[j,E]=c.useState(-1),[_,L]=c.useState(()=>new Set),[A,H]=c.useState(()=>new Set),[q,Y]=c.useState(!1),[U,X]=c.useState(!1),V=c.useMemo(()=>{const N=i.map(T=>T==null?void 0:T.uniqueId).filter(Boolean);return N.push(g,x,k,a,C,P,M,v,f,n,"ambient-goldfish","ambient-patronus"),new Set(N)},[x,a,C,k,P,M,v,f,n,g,i]),J=c.useMemo(()=>Array.from(A).filter(N=>N!=="ambient-goldfish"&&N!=="ambient-patronus"),[A]),K=t,re=R.selectedLanguageId||"en";c.useEffect(()=>{var D;if(typeof window>"u"||!window.matchMedia)return;const N=window.matchMedia("(pointer: coarse), (max-width: 640px)"),T=()=>X(N.matches);return T(),N.addEventListener?(N.addEventListener("change",T),()=>N.removeEventListener("change",T)):((D=N.addListener)==null||D.call(N,T),()=>{var O;return(O=N.removeListener)==null?void 0:O.call(N,T)})},[]);let Q=R.getString("send_yours");typeof Q=="string"&&Q.startsWith("locale:")&&(Q={en:"Send yours!",de:"Sende deine!",hr:"PoÅ¡alji svoju!",tr:"Sen de gÃ¶nder!"}[re]||"Send yours!");let W=R.getString("click");typeof W=="string"&&W.startsWith("locale:")&&(W={en:"Click",de:"Klicken",hr:"Klikni",tr:"TÄ±kla"}[re]||"Click");const se={en:{title:"Doors of the world behind an amazing art gallery.",guide:{eyebrow:"How to explore",lines:[[{text:"Enter the gallery",tone:"hero"},{text:" and browse the "},{text:"cards",tone:"glow"},{text:" at your own risk!",tone:"soft"}],[{text:"Click, hold, or drag",tone:"action"},{text:" inside a card to have "},{text:"some fun.",tone:"glow"}],[{text:"All pieces are unique, and beautiful.",tone:"hero"},{text:" "},{text:"Contact me to send or credit an idea.",tone:"soft"}]]},button:"Enter",preparing:"Preparing..."},de:{title:"Türen der Welt hinter einer erstaunlichen Kunstgalerie.",guide:{eyebrow:"So funktioniert es",lines:["Betritt die Galerie und schau dir die Karten in Ruhe an.","Klicke, tippe oder halte eine Karte, um das Werk darin sichtbar zu machen.","Manche Werke reagieren anders, und einige brauchen einen kurzen Moment zum Laden."]},button:"Eintreten",preparing:"Wird vorbereitet..."},hr:{title:"Vrata svijeta iza nevjerojatne umjetničke galerije.",guide:{eyebrow:"Kako istraživati",lines:["Uđi u galeriju i istražuj kartice svojim tempom.","Klikni, dodirni ili pritisni karticu da otkriješ što skriva.","Neki radovi reagiraju drugačije, a nekima treba trenutak da se pripreme."]},button:"Uđi",preparing:"Priprema se..."},tr:{title:"Muhteşem bir sanat galerisinin ardındaki dünyanın kapıları.",guide:{eyebrow:"Nasıl gezilir",lines:["Galeriye girin ve kartları kendi temponuzda inceleyin.","İçindekini ortaya çıkarmak için karta tıklayın, dokunun veya basılı tutun.","Bazı işler farklı tepki verir ve bazılarının hazırlanması biraz sürebilir."]},button:"Gir",preparing:"Hazırlanıyor..."}}[re]||{guide:{eyebrow:"How to explore",lines:[[{text:"Enter the gallery",tone:"hero"},{text:" and browse the "},{text:"cards",tone:"glow"},{text:" at your own risk!",tone:"soft"}],[{text:"Click, hold, or drag",tone:"action"},{text:" inside a card to have "},{text:"some fun.",tone:"glow"}],[{text:"All pieces are unique, and beautiful.",tone:"hero"},{text:" "},{text:"Contact me to send or credit an idea.",tone:"soft"}]]},button:"Enter"},xe="hide",G=c.useCallback(N=>{if(!N||w.current.has(N))return;w.current.add(N);const T=y.current.get(N);T!=null&&(window.clearTimeout(T),y.current.delete(N)),I(w.current.size)},[]),ie=c.useCallback(N=>{N&&H(T=>{if(T.has(N))return T;const D=new Set(T);return D.add(N),D})},[]),ee=c.useCallback(()=>{for(const N of y.current.values())window.clearTimeout(N);y.current=new Map,w.current=new Set,I(0),E(-1),h(!1),L(new Set),H(new Set),Y(!1)},[]),te=c.useCallback(()=>{H(new Set(V)),L(new Set(V)),Y(!0)},[V]),ne=c.useCallback(({openAll:N=!1}={})=>{if(o(!1),h(!0),E(i.length-1),N||U){te();return}L(new Set),H(new Set),Y(!1)},[i.length,te,U]);c.useEffect(()=>{var le;if(typeof window>"u"||((le=u.targetSection)==null?void 0:le.id)!==m.sectionId||u.transitionStatus!=="transition_status_none")return;const N=window.__pendingSectionAction;if(!N||N.action!=="enter"||N.sectionId!==m.sectionId||N.targetArticleId&&N.targetArticleId!==m.uniqueId)return;if(Date.now()-(N.requestedAt||0)>5e3){delete window.__pendingSectionAction;return}delete window.__pendingSectionAction,ne({openAll:!0});const T=N.targetArticleId||m.uniqueId;let D=null,O=null,F=null,Z=null;return D=window.setTimeout(()=>{O=window.requestAnimationFrame(()=>{fe(T,m.sectionId),F=window.setTimeout(()=>{Z=window.requestAnimationFrame(()=>{fe(T,m.sectionId)})},220)})},90),()=>{D!==null&&window.clearTimeout(D),O!==null&&window.cancelAnimationFrame(O),F!==null&&window.clearTimeout(F),Z!==null&&window.cancelAnimationFrame(Z)}},[m.uniqueId,m.sectionId,(ce=u.targetSection)==null?void 0:ce.id,u.transitionStatus,ne]);const oe=c.useCallback(N=>{N&&(ie(N),L(T=>{if(T.has(N))return T;const D=new Set(T);return D.add(N),D}))},[ie]),ae=c.useCallback(N=>{N&&(L(T=>{if(!T.has(N))return T;const D=new Set(T);return D.delete(N),D}),H(T=>{if(!T.has(N))return T;const D=new Set(T);return D.delete(N),D}))},[]),ve=V.size>0&&_.size>=V.size,ye=c.useCallback(()=>{if(V.size>0&&_.size>=V.size){L(new Set),H(new Set),Y(!1);return}te()},[V,te,_.size]),Me=c.useCallback(()=>{ee(),o(!0)},[ee]),Re=(N,T)=>{const D=Number(N==null?void 0:N.id);return D===1?"Hover":D===2?"Wave":D===3?"3D":D===4?"Poly":D===5?"Click":D===6?"Orbit":D===7?"Spin":D===8?"Shape":D===9?"Hourglass":D===10?"Noice":D===11?"Distance":D===12?"Android":D===13?"Pulse":D===14?"Bars":D===15?"Deep":String(T+1)},ge=i.map((N,T)=>{if(!l)return b.jsx("div",{className:"article-web-art-tile article-web-art-tile-placeholder","aria-label":`Web art tile ${T+1} loading`},N.uniqueId);const D=N.uniqueId,O=_.has(D),F=A.has(D)||O;return b.jsx(pe,{label:Re(N,T),isOpen:O,onToggle:()=>{O?ae(D):oe(D)},shouldRender:F,children:F&&b.jsx(He,{itemWrapper:N,index:T,locked:K||!O,activate:T<=j,onReady:G})},D)}),Ce=l?[{key:"ambient-trace",tileId:g,label:"Trace",render:N=>b.jsx(et,{readyId:g,locked:K||!N,onReady:G})},{key:"ambient-hex",tileId:x,label:"Hex",render:N=>b.jsx(tt,{readyId:x,locked:K||!N,onReady:G})},{key:"ambient-plop",tileId:k,label:"Plop",render:N=>b.jsx(rt,{readyId:k,locked:K||!N,onReady:G})},{key:"ambient-julia",tileId:a,label:"Julia",render:N=>b.jsx(nt,{readyId:a,locked:K||!N,onReady:G})},{key:"ambient-mines",tileId:C,label:"Bomb",render:N=>b.jsx(st,{readyId:C,locked:K||!N,onReady:G})},{key:"ambient-rings",tileId:M,label:"Fall",render:N=>b.jsx(it,{readyId:M,locked:K||!N,onReady:G})},{key:"ambient-prism",tileId:P,label:"Prism",render:N=>b.jsx(ot,{readyId:P,locked:K||!N,onReady:G})},{key:"ambient-rope",tileId:v,label:"Rope",render:N=>b.jsx(at,{readyId:v,locked:K||!N,onReady:G})},{key:"ambient-soup",tileId:f,label:"Soup",render:N=>b.jsx(ut,{readyId:f,locked:K||!N,onReady:G})},{key:"ambient-tardis",tileId:n,label:"Tardis",render:N=>b.jsx(dt,{readyId:n,locked:K||!N,onReady:G})},{key:"ambient-goldfish",tileId:"ambient-goldfish",label:"Fish",render:N=>b.jsx(ht,{locked:K||!N})},{key:"ambient-patronus",tileId:"ambient-patronus",label:"Patronus",render:N=>b.jsx(bt,{locked:K||!N})}].map(({key:N,tileId:T,label:D,render:O})=>{const F=_.has(T),Z=A.has(T)||F;return b.jsx(pe,{label:D,isOpen:F,onToggle:()=>{F?ae(T):oe(T)},shouldRender:Z,children:Z&&O(F)},N)}):[b.jsx("div",{className:"article-web-art-tile article-web-art-tile-placeholder","aria-label":"Web art trace tile loading"},"ambient-trace"),b.jsx("div",{className:"article-web-art-tile article-web-art-tile-placeholder","aria-label":"Web art hex tile loading"},"ambient-hex"),b.jsx("div",{className:"article-web-art-tile article-web-art-tile-placeholder","aria-label":"Web art plop tile loading"},"ambient-plop"),b.jsx("div",{className:"article-web-art-tile article-web-art-tile-placeholder","aria-label":"Web art julia tile loading"},"ambient-julia"),b.jsx("div",{className:"article-web-art-tile article-web-art-tile-placeholder","aria-label":"Web art mines tile loading"},"ambient-mines"),b.jsx("div",{className:"article-web-art-tile article-web-art-tile-placeholder","aria-label":"Web art rings tile loading"},"ambient-rings"),b.jsx("div",{className:"article-web-art-tile article-web-art-tile-placeholder","aria-label":"Web art prism tile loading"},"ambient-prism"),b.jsx("div",{className:"article-web-art-tile article-web-art-tile-placeholder","aria-label":"Web art rope tile loading"},"ambient-rope"),b.jsx("div",{className:"article-web-art-tile article-web-art-tile-placeholder","aria-label":"Web art soup tile loading"},"ambient-soup"),b.jsx("div",{className:"article-web-art-tile article-web-art-tile-placeholder","aria-label":"Web art tardis tile loading"},"ambient-tardis")];return c.useEffect(()=>{ee()},[m.uniqueId,ee]),c.useEffect(()=>{l&&E(i.length-1)},[l,i.length]),c.useEffect(()=>{if(l)for(const N of J){if(!N||w.current.has(N)||y.current.has(N))continue;const T=window.setTimeout(()=>{G(N)},12e3);y.current.set(N,T)}},[l,J,G]),b.jsx(ue,{id:m.uniqueId,type:ue.Types.SPACING_DEFAULT,dataWrapper:m,className:"article-web-art",selectedItemCategoryId:e,setSelectedItemCategoryId:r,children:b.jsxs("div",{className:"article-web-art-shell",children:[b.jsx(Oe,{guide:se.guide,buttonLabel:t?se.button:xe,hidden:!t,onEnter:t?ne:Me,secondaryButtonLabel:t?null:"promaja",onSecondaryAction:t?null:ye,secondaryPressed:ve}),b.jsx("div",{className:`article-web-art-stage ${t?"article-web-art-stage-preview":""}`,"aria-hidden":t,children:b.jsxs("div",{className:`article-web-art-items ${K?"article-web-art-items-locked":""}`,ref:d,"aria-busy":t,children:[l&&b.jsx(ft,{label:Q,clickLabel:W,previewRequested:q}),ge,Ce]})})]})})}function Oe({guide:m,buttonLabel:p,hidden:R,onEnter:u,secondaryButtonLabel:g=null,onSecondaryAction:x=null,secondaryPressed:k=!1}){const a=C=>{(C.key==="Enter"||C.key===" ")&&(C.preventDefault(),u())};return b.jsx("div",{className:`article-web-art-intro-cover ${R?"article-web-art-intro-cover-hidden":"article-web-art-intro-cover-open"}`,children:b.jsx("div",{className:"article-web-art-intro-cover-inner",children:b.jsx("div",{className:"article-web-art-intro-cover-actions",children:b.jsx("div",{className:`article-web-art-intro-guide ${R?"article-web-art-intro-guide-hidden":"article-web-art-intro-guide-open"}`,children:b.jsxs("div",{className:"article-web-art-intro-guide-inner",children:[b.jsxs("div",{className:"article-web-art-intro-guide-top-row",children:[b.jsxs("div",{className:"article-web-art-intro-guide-top-copy",children:[b.jsx("span",{className:"article-web-art-intro-guide-eyebrow",children:m.eyebrow}),b.jsx("p",{className:"article-web-art-intro-guide-line article-web-art-intro-guide-line-primary",children:be(m.lines[0])})]}),b.jsxs("div",{className:"article-web-art-intro-cover-buttons",children:[g?b.jsx("button",{type:"button",className:`article-web-art-intro-cover-button article-web-art-intro-cover-button-secondary ${k?"article-web-art-intro-cover-button-secondary-active":""}`,onClick:x||void 0,"aria-pressed":k,"aria-label":g,children:g}):null,b.jsx("button",{type:"button",className:"article-web-art-intro-cover-button",onClick:u,onKeyDown:a,"aria-label":p,children:p})]})]}),b.jsx("div",{className:"article-web-art-intro-guide-lines",children:m.lines.slice(1).map((C,M)=>b.jsx("p",{className:`article-web-art-intro-guide-line article-web-art-intro-guide-line-${M+2}`,children:be(C)},Array.isArray(C)?C.map(P=>P==null?void 0:P.text).join(""):C))})]})})})})})}function pe({label:m,isOpen:p,onToggle:R,shouldRender:u=!0,children:g}){return b.jsxs("div",{className:`article-web-art-gated-tile ${p?"article-web-art-gated-tile-open":"article-web-art-gated-tile-closed"}`,children:[u?g:b.jsx("div",{className:"article-web-art-tile article-web-art-tile-placeholder","aria-label":De(m)}),b.jsx("div",{className:"article-web-art-gated-tile-sheet","aria-hidden":!0}),b.jsx("button",{type:"button",className:`article-web-art-gated-tile-pill ${p?"article-web-art-gated-tile-pill-open":"article-web-art-gated-tile-pill-closed"}`,onClick:R,"aria-label":`${p?"Hide":"Show"} ${m}`,children:m})]})}function He({itemWrapper:m,index:p,activate:R,locked:u,onReady:g}){return Number(m.id)===1?b.jsx(Xe,{itemWrapper:m,index:p,activate:R,locked:u,onReady:g}):Number(m.id)===2?b.jsx(Ze,{itemWrapper:m,index:p,activate:R,locked:u,onReady:g}):Number(m.id)===3?b.jsx(Je,{itemWrapper:m,index:p,activate:R,locked:u,onReady:g}):Number(m.id)===4?b.jsx(Qe,{itemWrapper:m,index:p,activate:R,locked:u,onReady:g}):Number(m.id)===6?b.jsx(We,{itemWrapper:m,index:p,activate:R,locked:u,onReady:g}):Number(m.id)===7?b.jsx($e,{itemWrapper:m,locked:u,onReady:g}):Number(m.id)===8?b.jsx(qe,{itemWrapper:m,index:p,activate:R,locked:u,onReady:g}):Number(m.id)===9?b.jsx(Ke,{itemWrapper:m,index:p,activate:R,locked:u,onReady:g}):Number(m.id)===10?b.jsx(Ve,{itemWrapper:m,index:p,activate:R,locked:u,onReady:g}):Number(m.id)===11?b.jsx(Be,{itemWrapper:m,index:p,activate:R,locked:u,onReady:g}):Number(m.id)===12?b.jsx(ze,{itemWrapper:m,index:p,activate:R,locked:u,onReady:g}):Number(m.id)===13?b.jsx(Ue,{itemWrapper:m,index:p,activate:R,locked:u,onReady:g}):Number(m.id)===14?b.jsx(Fe,{itemWrapper:m,index:p,activate:R,locked:u,onReady:g}):Number(m.id)===15?b.jsx(Ge,{itemWrapper:m,index:p,activate:R,locked:u,onReady:g}):b.jsx(Ye,{itemWrapper:m,index:p,activate:R,locked:u,onReady:g})}function Be({itemWrapper:m,index:p,activate:R,locked:u,onReady:g}){const x=c.useRef(null),k=c.useRef(null),a=c.useRef(null),C=c.useRef(!1),M=c.useRef(!0),P=c.useRef(null),v=c.useMemo(()=>typeof window>"u"||!window.matchMedia?!1:window.matchMedia("(prefers-reduced-motion: reduce)").matches,[]),f=c.useMemo(()=>({seed:54013+(Number(m.id)||11)*7331,reduceMotion:v}),[m.id,v]);c.useEffect(()=>{if(!R)return;const e=x.current,r=k.current;if(!e||!r)return;let t=!1,o=null,s=null,i=null;const d=()=>{C.current||(C.current=!0,g==null||g(m.uniqueId))},l=$(async()=>{var h,w;try{const y=await B(()=>import("./distanceFieldEngine-DHTRwy4W.js"),[]);if(t)return;o=y.createDistanceFieldEngine(r,f),a.current=o;const S=()=>z(e,o,Math.min(1.5,window.devicePixelRatio||1));S(),(h=o.renderStatic)==null||h.call(o),u||(w=o.start)==null||w.call(o),d(),s=new ResizeObserver(()=>{S()}),s.observe(e),"IntersectionObserver"in window&&(i=new IntersectionObserver(I=>{var j,E,_,L;for(const A of I){if(M.current=!!A.isIntersecting,u){(j=o.setHoverActive)==null||j.call(o,!1),(E=o.stop)==null||E.call(o);continue}M.current?(_=o.start)==null||_.call(o):(L=o.stop)==null||L.call(o)}},{threshold:.25}),i.observe(e))}catch{d()}},{timeoutMs:220});return()=>{var h;t=!0,l==null||l(),i==null||i.disconnect(),s==null||s.disconnect(),(h=o==null?void 0:o.destroy)==null||h.call(o),a.current=null}},[R,f,m.uniqueId,u,g]),c.useEffect(()=>{var r,t,o,s;const e=a.current;if(e){if(u){(r=e.setHoverActive)==null||r.call(e,!1),(t=e.clearPointer)==null||t.call(e),(o=e.stop)==null||o.call(e);return}M.current&&((s=e.start)==null||s.call(e))}},[u]);const n=e=>{const r=x.current;if(!r)return{x:.5,y:.5};const t=r.getBoundingClientRect();return{x:Math.max(0,Math.min(1,(e.clientX-t.left)/Math.max(1,t.width))),y:Math.max(0,Math.min(1,(e.clientY-t.top)/Math.max(1,t.height)))}};return b.jsxs("button",{type:"button",ref:x,className:"article-web-art-tile article-web-art-tile-clickable","aria-label":`Distance web art tile ${p+1}`,disabled:u,onPointerEnter:u?void 0:(()=>{var e,r,t,o;(r=(e=a.current)==null?void 0:e.setHoverActive)==null||r.call(e,!0),(o=(t=a.current)==null?void 0:t.start)==null||o.call(t)}),onPointerMove:u?void 0:(e=>{var t,o,s,i;const r=n(e);(o=(t=a.current)==null?void 0:t.setHoverActive)==null||o.call(t,!0),(i=(s=a.current)==null?void 0:s.setPointer)==null||i.call(s,r.x,r.y)}),onPointerLeave:u?void 0:(()=>{var e,r,t,o;P.current=null,(r=(e=a.current)==null?void 0:e.setHoverActive)==null||r.call(e,!1),(o=(t=a.current)==null?void 0:t.clearPointer)==null||o.call(t)}),onPointerDown:u?void 0:(e=>{var t,o,s,i,d,l;if(e.button!=null&&e.button!==0)return;P.current=e.pointerId;try{e.currentTarget.setPointerCapture(e.pointerId)}catch{}const r=n(e);(o=(t=a.current)==null?void 0:t.setHoverActive)==null||o.call(t,!0),(i=(s=a.current)==null?void 0:s.setPointer)==null||i.call(s,r.x,r.y),(l=(d=a.current)==null?void 0:d.boostPopulation)==null||l.call(d)}),onPointerUp:u?void 0:(e=>{P.current!=null&&e.pointerId!==P.current||(P.current=null)}),onPointerCancel:u?void 0:(()=>{var e,r,t,o;P.current=null,(r=(e=a.current)==null?void 0:e.setHoverActive)==null||r.call(e,!1),(o=(t=a.current)==null?void 0:t.clearPointer)==null||o.call(t)}),onFocus:u?void 0:(()=>{var e,r,t,o;(r=(e=a.current)==null?void 0:e.setHoverActive)==null||r.call(e,!0),(o=(t=a.current)==null?void 0:t.start)==null||o.call(t)}),onBlur:u?void 0:(()=>{var e,r,t,o;P.current=null,(r=(e=a.current)==null?void 0:e.setHoverActive)==null||r.call(e,!1),(o=(t=a.current)==null?void 0:t.clearPointer)==null||o.call(t)}),onKeyDown:u?void 0:(e=>{var r,t;(e.key==="Enter"||e.key===" ")&&(e.preventDefault(),(t=(r=a.current)==null?void 0:r.boostPopulation)==null||t.call(r))}),children:[b.jsx("canvas",{ref:k,className:"article-web-art-canvas"}),b.jsx("span",{className:"article-web-art-tile-label",children:"Distance"})]})}function ze({itemWrapper:m,index:p,activate:R,locked:u,onReady:g}){const x=c.useRef(null),k=c.useRef(null),a=c.useRef(null),C=c.useRef(null),M=c.useRef(null),P=c.useRef(!1),v=c.useRef(!0),f=c.useMemo(()=>typeof window>"u"||!window.matchMedia?!1:window.matchMedia("(prefers-reduced-motion: reduce)").matches,[]);c.useEffect(()=>{if(!R)return;const e=x.current,r=k.current,t=a.current;if(!e||!r||!t)return;let o=!1,s=null,i=null,d=null,l=null;const h=()=>{P.current||(P.current=!0,g==null||g(m.uniqueId))},w=$(async()=>{var y,S,I,j;try{const E=await B(()=>import("./androidBackgroundEngine-HmTe5YFf.js"),__vite__mapDeps([0,1])),_=await B(()=>import("./androidRobotEngine-CNxYykCI.js"),[]);if(o)return;s=E.createAndroidBackgroundEngine(r,{reduceMotion:f}),C.current=s,i=_.createAndroidRobotEngine(t,{reduceMotion:f}),M.current=i;const L=()=>{const A=Math.min(1.5,window.devicePixelRatio||1);z(e,s,A),z(e,i,A)};L(),(y=s.renderStatic)==null||y.call(s),(S=i.renderStatic)==null||S.call(i),u||(I=s.start)==null||I.call(s),u||(j=i.start)==null||j.call(i),h(),d=new ResizeObserver(()=>{L()}),d.observe(e),"IntersectionObserver"in window&&(l=new IntersectionObserver(A=>{var H,q,Y,U,X,V;for(const J of A){if(v.current=!!J.isIntersecting,u){(H=s.stop)==null||H.call(s),(q=i.stop)==null||q.call(i);continue}v.current?((Y=s.start)==null||Y.call(s),(U=i.start)==null||U.call(i)):((X=s.stop)==null||X.call(s),(V=i.stop)==null||V.call(i))}},{threshold:.2}),l.observe(e))}catch{h()}},{timeoutMs:220});return()=>{var y,S;o=!0,w==null||w(),l==null||l.disconnect(),d==null||d.disconnect(),(y=s==null?void 0:s.destroy)==null||y.call(s),(S=i==null?void 0:i.destroy)==null||S.call(i),C.current=null,M.current=null}},[R,m.uniqueId,u,g,f]),c.useEffect(()=>{var t,o,s,i,d;const e=M.current,r=C.current;if(!(!e||!r)){if(u){(t=e.clearPointer)==null||t.call(e),(o=r.stop)==null||o.call(r),(s=e.stop)==null||s.call(e);return}v.current&&((i=r.start)==null||i.call(r),(d=e.start)==null||d.call(e))}},[u]);const n=e=>{const r=x.current;if(!r)return{x:.5,y:.5};const t=r.getBoundingClientRect();return{x:Math.max(0,Math.min(1,(e.clientX-t.left)/Math.max(1,t.width))),y:Math.max(0,Math.min(1,(e.clientY-t.top)/Math.max(1,t.height)))}};return b.jsxs("button",{type:"button",ref:x,className:"article-web-art-tile article-web-art-tile-clickable article-web-art-tile-android","aria-label":`Android web art tile ${p+1}`,disabled:u,onPointerEnter:u?void 0:(()=>{var e,r;(r=(e=M.current)==null?void 0:e.start)==null||r.call(e)}),onPointerMove:u?void 0:(e=>{var t,o;const r=n(e);(o=(t=M.current)==null?void 0:t.setPointer)==null||o.call(t,r.x,r.y)}),onPointerLeave:u?void 0:(()=>{var e,r;(r=(e=M.current)==null?void 0:e.clearPointer)==null||r.call(e)}),onFocus:u?void 0:(()=>{var e,r;(r=(e=M.current)==null?void 0:e.start)==null||r.call(e)}),onBlur:u?void 0:(()=>{var e,r;(r=(e=M.current)==null?void 0:e.clearPointer)==null||r.call(e)}),onClick:u?void 0:(()=>{var e,r;(r=(e=M.current)==null?void 0:e.poke)==null||r.call(e)}),onKeyDown:u?void 0:(e=>{var r,t;(e.key==="Enter"||e.key===" ")&&(e.preventDefault(),(t=(r=M.current)==null?void 0:r.poke)==null||t.call(r))}),children:[b.jsx("canvas",{ref:k,className:"article-web-art-android-bg-canvas","aria-hidden":!0}),b.jsx("div",{className:"article-web-art-android-glow","aria-hidden":!0}),b.jsx("canvas",{ref:a,className:"article-web-art-android-canvas"}),b.jsx("span",{className:"article-web-art-tile-label",children:"Android"})]})}function $e({itemWrapper:m,locked:p,onReady:R}){const u=c.useRef(!1);c.useEffect(()=>{u.current||(u.current=!0,R==null||R(m.uniqueId))},[m.uniqueId,R]);const g=c.useMemo(()=>[{key:"stop",hoverMode:"stop",hoverDuration:"5s"},{key:"slow",hoverMode:"slow",hoverDuration:"18s"},{key:"super-fast",hoverMode:"super-fast",hoverDuration:"0.22s"},{key:"very-fast",hoverMode:"very-fast",hoverDuration:"0.55s"}],[]);return b.jsx("div",{className:`article-web-art-tile article-web-art-spin-boxes ${p?"article-web-art-spin-boxes-locked":""}`,children:b.jsx("div",{className:"article-web-art-spin-boxes-grid",children:g.map(({key:x,hoverDuration:k,hoverMode:a})=>b.jsx("div",{className:"article-web-art-spin-box",style:{"--spin-duration":"5s","--spin-hover-duration":k},children:b.jsx("div",{className:`article-web-art-spin-box-core article-web-art-spin-box-core-${a}`})},x))})})}function Fe({itemWrapper:m,index:p,activate:R,locked:u,onReady:g}){const x=c.useRef(!1),k=50,a=c.useMemo(()=>["level-1","level-2","level-3","level-4","level-5"],[]),[C,M]=c.useState(0),P=a[C],v=c.useMemo(()=>Array.from({length:k},(n,e)=>{const r=`${3/(k/2)*(e+1)}s`;return{key:e,style:{animationDelay:r,"--bar-index":e}}}),[]),f=c.useCallback(n=>{var e,r;(e=n==null?void 0:n.preventDefault)==null||e.call(n),(r=n==null?void 0:n.stopPropagation)==null||r.call(n),M(t=>(t+1)%a.length)},[a.length]);return c.useEffect(()=>{R&&(x.current||(x.current=!0,g==null||g(m.uniqueId)))},[R,m.uniqueId,g]),b.jsx("button",{type:"button",className:"article-web-art-tile article-web-art-bars-tile article-web-art-tile-clickable","aria-label":`Bars web art tile ${p+1}, ${P.replace("level-","mode ")}`,disabled:u,onClick:u?void 0:f,onKeyDown:u?void 0:n=>{(n.key==="Enter"||n.key===" ")&&f(n)},children:b.jsx("div",{className:`article-web-art-bars-stage article-web-art-bars-stage-${P}`,children:b.jsx("div",{className:`article-web-art-bars article-web-art-bars-${P}`,children:v.map(n=>b.jsx("div",{className:"article-web-art-bars-panel",style:n.style},n.key))})})})}function qe({itemWrapper:m,index:p,activate:R,locked:u,onReady:g}){const x=c.useRef(null),k=c.useRef(null),a=c.useRef(null),C=c.useRef(!1),M=c.useRef(!0),P=c.useMemo(()=>typeof window>"u"||!window.matchMedia?!1:window.matchMedia("(prefers-reduced-motion: reduce)").matches,[]),v=c.useMemo(()=>({seed:1729+(Number(m.id)||8)*4242,reduceMotion:P,gap:18,radiusRatio:.4,restScale:.28,minHoverScale:1.65,maxHoverScale:5.4,waveWidth:260}),[m.id,P]);c.useEffect(()=>{if(!R)return;const t=x.current,o=k.current;if(!t||!o)return;let s=!1,i=null,d=null,l=null;const h=()=>{C.current||(C.current=!0,g==null||g(m.uniqueId))},w=$(async()=>{var y,S,I;try{const j=await B(()=>import("./shapeFieldEngine-B_ToSidK.js"),[]);if(s)return;i=j.createShapeFieldEngine(o,v),a.current=i;const E=()=>z(t,i,window.devicePixelRatio||1);E(),(y=i.renderStatic)==null||y.call(i),(S=i.triggerWave)==null||S.call(i),u||(I=i.start)==null||I.call(i),h(),d=new ResizeObserver(()=>{var _;E(),(_=i.renderStatic)==null||_.call(i)}),d.observe(t),"IntersectionObserver"in window&&(l=new IntersectionObserver(_=>{var L,A,H;for(const q of _){if(M.current=!!q.isIntersecting,u){(L=i.stop)==null||L.call(i);continue}M.current?(A=i.start)==null||A.call(i):(H=i.stop)==null||H.call(i)}},{threshold:.2}),l.observe(t))}catch{h()}});return()=>{var y;s=!0,w==null||w(),l==null||l.disconnect(),d==null||d.disconnect(),(y=i==null?void 0:i.destroy)==null||y.call(i),a.current=null}},[R,v,m.uniqueId,u,g]),c.useEffect(()=>{var o,s,i;const t=a.current;if(t){if(u){(o=t.clearPointer)==null||o.call(t),(s=t.stop)==null||s.call(t);return}M.current&&((i=t.start)==null||i.call(t))}},[u]);const f=t=>{const o=k.current||x.current;if(!o)return{x:0,y:0};const s=o.getBoundingClientRect();return{x:t.clientX-s.left,y:t.clientY-s.top}},n=t=>{var s,i;const o=f(t);(i=(s=a.current)==null?void 0:s.setPointer)==null||i.call(s,o.x,o.y)},e=t=>{var s,i,d,l;const o=f(t);(i=(s=a.current)==null?void 0:s.setPointer)==null||i.call(s,o.x,o.y),(l=(d=a.current)==null?void 0:d.triggerWave)==null||l.call(d,o.x,o.y)},r=t=>{var o,s;t.key!=="Enter"&&t.key!==" "||(t.preventDefault(),(s=(o=a.current)==null?void 0:o.triggerWave)==null||s.call(o))};return b.jsxs("button",{type:"button",ref:x,className:"article-web-art-tile article-web-art-tile-clickable article-web-art-tile-shape","aria-label":`Shape web art tile ${p+1}`,disabled:u,onPointerMove:u?void 0:n,onPointerDown:u?void 0:e,onPointerLeave:u?void 0:(()=>{var t,o;return(o=(t=a.current)==null?void 0:t.clearPointer)==null?void 0:o.call(t)}),onBlur:u?void 0:(()=>{var t,o;return(o=(t=a.current)==null?void 0:t.clearPointer)==null?void 0:o.call(t)}),onKeyDown:u?void 0:r,children:[b.jsx("canvas",{ref:k,className:"article-web-art-canvas"}),b.jsx("span",{className:"article-web-art-tile-label",children:"Shape"})]})}function Ke({itemWrapper:m,index:p,activate:R,locked:u,onReady:g}){const x=c.useRef(null),k=c.useRef(null),a=c.useRef(null),C=c.useRef(!1),M=c.useRef(!0),[P,v]=c.useState(2.8),[f,n]=c.useState(.01);c.useEffect(()=>{if(!R)return;const i=x.current,d=k.current;if(!i||!d)return;let l=!1,h=null,w=null,y=null;const S=()=>{C.current||(C.current=!0,g==null||g(m.uniqueId))},I=$(async()=>{var j,E,_;try{const L=await B(()=>import("./hourglassEngine-G8I2lkhm.js"),__vite__mapDeps([2,3,4]));if(l)return;h=L.createHourglassEngine(d),a.current=h;const A=(j=h.getState)==null?void 0:j.call(h);A&&(v(A.gravity),n(A.neckRatio));const H=()=>z(i,h,window.devicePixelRatio||1);H(),(E=h.renderStatic)==null||E.call(h),u||(_=h.start)==null||_.call(h),S(),w=new ResizeObserver(()=>{var q;H(),(q=h.renderStatic)==null||q.call(h)}),w.observe(i),"IntersectionObserver"in window&&(y=new IntersectionObserver(q=>{var Y,U,X;for(const V of q){if(M.current=!!V.isIntersecting,u){(Y=h.stop)==null||Y.call(h);continue}M.current?(U=h.start)==null||U.call(h):(X=h.stop)==null||X.call(h)}},{threshold:.2}),y.observe(i))}catch{S()}});return()=>{var j;l=!0,I==null||I(),y==null||y.disconnect(),w==null||w.disconnect(),(j=h==null?void 0:h.destroy)==null||j.call(h),a.current=null}},[R,m.uniqueId,u,g]),c.useEffect(()=>{var d,l;const i=a.current;if(i){if(u){(d=i.stop)==null||d.call(i);return}M.current&&((l=i.start)==null||l.call(i))}},[u]);const e=i=>{var d,l;i.key!=="Enter"&&i.key!==" "||(i.preventDefault(),(l=(d=a.current)==null?void 0:d.flip)==null||l.call(d))},r=i=>{i.stopPropagation()},t=i=>{i.stopPropagation()},o=i=>{var l,h;const d=Number(i.target.value);v(d),(h=(l=a.current)==null?void 0:l.setGravity)==null||h.call(l,d)},s=i=>{var l,h,w,y;const d=Number(i.target.value);n(d),(h=(l=a.current)==null?void 0:l.setNeckRatio)==null||h.call(l,d),!u&&M.current&&((y=(w=a.current)==null?void 0:w.start)==null||y.call(w))};return b.jsxs("div",{ref:x,className:"article-web-art-tile article-web-art-tile-clickable article-web-art-tile-hourglass",role:u?void 0:"button",tabIndex:u?-1:0,"aria-label":`Hourglass web art tile ${p+1}`,onClick:u?void 0:(()=>{var i,d;return(d=(i=a.current)==null?void 0:i.flip)==null?void 0:d.call(i)}),onKeyDown:u?void 0:e,children:[b.jsx("canvas",{ref:k,className:"article-web-art-canvas"}),b.jsxs("div",{className:"article-web-art-hourglass-controls",onClickCapture:t,onPointerDownCapture:t,onPointerUpCapture:t,onClick:r,onPointerDown:r,onPointerUp:r,onKeyDown:r,children:[b.jsxs("label",{className:"article-web-art-hourglass-control article-web-art-hourglass-control-left",children:[b.jsx("span",{className:"article-web-art-hourglass-control-name",children:"Neck"}),b.jsx("input",{className:"article-web-art-hourglass-slider",type:"range",min:"0.01",max:"0.22",step:"0.001",value:f,onChange:s,disabled:u,"aria-label":"Hourglass neck size"})]}),b.jsxs("label",{className:"article-web-art-hourglass-control article-web-art-hourglass-control-right",children:[b.jsx("span",{className:"article-web-art-hourglass-control-name",children:"Gravity"}),b.jsx("input",{className:"article-web-art-hourglass-slider",type:"range",min:"0.45",max:"2.8",step:"0.01",value:P,onChange:o,disabled:u,"aria-label":"Hourglass gravity"})]})]}),b.jsx("span",{className:"article-web-art-tile-label",children:"Hourglass"})]})}function Ve({itemWrapper:m,index:p,activate:R,locked:u,onReady:g}){const x=c.useRef(null),k=c.useRef(null),a=c.useRef(null),C=c.useRef(!1),M=c.useRef(!0),P=c.useMemo(()=>typeof window>"u"||!window.matchMedia?!1:window.matchMedia("(prefers-reduced-motion: reduce)").matches,[]);c.useEffect(()=>{if(!R)return;const n=x.current,e=k.current;if(!n||!e)return;let r=!1,t=null,o=null,s=null;const i=()=>{C.current||(C.current=!0,g==null||g(m.uniqueId))},d=$(async()=>{var l,h;try{const w=await B(()=>import("./noiceShaderEngine-6wwfZdln.js"),[]);if(r)return;t=w.createNoiceShaderEngine(e,{reduceMotion:P}),a.current=t;const y=()=>z(n,t,Math.min(1.5,window.devicePixelRatio||1));y(),(l=t.renderStatic)==null||l.call(t),u||(h=t.start)==null||h.call(t),i(),o=new ResizeObserver(()=>{var S;y(),(S=t.renderStatic)==null||S.call(t)}),o.observe(n),"IntersectionObserver"in window&&(s=new IntersectionObserver(S=>{var I,j,E;for(const _ of S){if(M.current=!!_.isIntersecting,u){(I=t.stop)==null||I.call(t);continue}M.current?(j=t.start)==null||j.call(t):(E=t.stop)==null||E.call(t)}},{threshold:.25}),s.observe(n))}catch{i()}},{timeoutMs:220});return()=>{var l;r=!0,d==null||d(),s==null||s.disconnect(),o==null||o.disconnect(),(l=t==null?void 0:t.destroy)==null||l.call(t),a.current=null}},[R,m.uniqueId,u,g,P]),c.useEffect(()=>{var e,r,t;const n=a.current;if(n){if(u){(e=n.clearPointer)==null||e.call(n),(r=n.stop)==null||r.call(n);return}M.current&&((t=n.start)==null||t.call(n))}},[u]);const v=n=>{const e=k.current||x.current;if(!e)return{x:.5,y:.5};const r=e.getBoundingClientRect();return{x:Math.max(0,Math.min(1,(n.clientX-r.left)/Math.max(1,r.width))),y:Math.max(0,Math.min(1,(n.clientY-r.top)/Math.max(1,r.height)))}},f=n=>{var r,t,o,s,i,d;const e=v(n);(t=(r=a.current)==null?void 0:r.setPointer)==null||t.call(r,e.x,e.y),(s=(o=a.current)==null?void 0:o.pulsePattern)==null||s.call(o),(d=(i=a.current)==null?void 0:i.start)==null||d.call(i)};return b.jsxs("button",{type:"button",ref:x,className:"article-web-art-tile article-web-art-tile-clickable article-web-art-tile-noice","aria-label":`Noice web art tile ${p+1}`,disabled:u,onPointerMove:u?void 0:(n=>{var r,t;const e=v(n);(t=(r=a.current)==null?void 0:r.setPointer)==null||t.call(r,e.x,e.y)}),onPointerDown:u?void 0:(n=>{n.button!=null&&n.button!==0||f(n)}),onMouseLeave:u?void 0:(()=>{var n,e;(e=(n=a.current)==null?void 0:n.clearPointer)==null||e.call(n)}),onBlur:u?void 0:(()=>{var n,e;(e=(n=a.current)==null?void 0:n.clearPointer)==null||e.call(n)}),onKeyDown:u?void 0:(n=>{var e,r,t,o;(n.key==="Enter"||n.key===" ")&&(n.preventDefault(),(r=(e=a.current)==null?void 0:e.pulsePattern)==null||r.call(e),(o=(t=a.current)==null?void 0:t.start)==null||o.call(t))}),children:[b.jsx("canvas",{ref:k,className:"article-web-art-canvas"}),b.jsx("span",{className:"article-web-art-tile-label",children:"Noice"})]})}function Ge({itemWrapper:m,index:p,activate:R,locked:u,onReady:g}){const x=c.useRef(null),k=c.useRef(null),a=c.useRef(null),C=c.useRef(!1),M=c.useRef(!0),P=c.useRef(null),v=c.useMemo(()=>typeof window>"u"||!window.matchMedia?!1:window.matchMedia("(prefers-reduced-motion: reduce)").matches,[]);c.useEffect(()=>{if(!R)return;const n=x.current,e=k.current;if(!n||!e)return;let r=!1,t=null,o=null,s=null;const i=()=>{C.current||(C.current=!0,g==null||g(m.uniqueId))},d=$(async()=>{var l,h;try{const w=await B(()=>import("./deepShaderEngine-CuYCvQ1H.js"),[]);if(r)return;t=w.createDeepShaderEngine(e,{reduceMotion:v}),a.current=t;const y=()=>z(n,t,Math.min(1.5,window.devicePixelRatio||1));y(),(l=t.renderStatic)==null||l.call(t),u||(h=t.start)==null||h.call(t),i(),o=new ResizeObserver(()=>{var S;y(),(S=t.renderStatic)==null||S.call(t)}),o.observe(n),"IntersectionObserver"in window&&(s=new IntersectionObserver(S=>{var I,j,E;for(const _ of S){if(M.current=!!_.isIntersecting,u){(I=t.stop)==null||I.call(t);continue}M.current?(j=t.start)==null||j.call(t):(E=t.stop)==null||E.call(t)}},{threshold:.25}),s.observe(n))}catch{i()}},{timeoutMs:220});return()=>{var l;r=!0,d==null||d(),s==null||s.disconnect(),o==null||o.disconnect(),(l=t==null?void 0:t.destroy)==null||l.call(t),a.current=null}},[R,m.uniqueId,u,g,v]),c.useEffect(()=>{var e,r,t;const n=a.current;if(n){if(u){P.current=null,(e=n.clearPointer)==null||e.call(n),(r=n.stop)==null||r.call(n);return}M.current&&((t=n.start)==null||t.call(n))}},[u]);const f=n=>{const e=k.current||x.current;if(!e)return{x:.5,y:.5};const r=e.getBoundingClientRect();return{x:Math.max(0,Math.min(1,(n.clientX-r.left)/Math.max(1,r.width))),y:Math.max(0,Math.min(1,(n.clientY-r.top)/Math.max(1,r.height)))}};return b.jsxs("button",{type:"button",ref:x,className:"article-web-art-tile article-web-art-tile-clickable article-web-art-tile-deep","aria-label":`Deep web art tile ${p+1}`,disabled:u,onPointerDown:u?void 0:n=>{var r,t,o,s;if(n.button!=null&&n.button!==0)return;P.current=n.pointerId;try{n.currentTarget.setPointerCapture(n.pointerId)}catch{}const e=f(n);(t=(r=a.current)==null?void 0:r.setPointer)==null||t.call(r,e.x,e.y),(s=(o=a.current)==null?void 0:o.start)==null||s.call(o)},onPointerMove:u?void 0:n=>{var r,t;if(P.current!=null&&n.pointerId!==P.current||P.current==null&&n.pointerType!=="mouse")return;const e=f(n);P.current!=null&&((t=(r=a.current)==null?void 0:r.setPointer)==null||t.call(r,e.x,e.y))},onPointerUp:u?void 0:n=>{var e,r;P.current!=null&&n.pointerId!==P.current||(P.current=null,(r=(e=a.current)==null?void 0:e.clearPointer)==null||r.call(e))},onPointerCancel:u?void 0:(()=>{var n,e;P.current=null,(e=(n=a.current)==null?void 0:n.clearPointer)==null||e.call(n)}),onMouseLeave:u?void 0:(()=>{var n,e;P.current=null,(e=(n=a.current)==null?void 0:n.clearPointer)==null||e.call(n)}),onBlur:u?void 0:(()=>{var n,e;P.current=null,(e=(n=a.current)==null?void 0:n.clearPointer)==null||e.call(n)}),onKeyDown:u?void 0:(n=>{var e,r;(n.key==="Enter"||n.key===" ")&&(n.preventDefault(),(r=(e=a.current)==null?void 0:e.start)==null||r.call(e))}),children:[b.jsx("canvas",{ref:k,className:"article-web-art-canvas"}),b.jsx("span",{className:"article-web-art-tile-label",children:"Deep"})]})}function Ye({itemWrapper:m,index:p,activate:R,locked:u,onReady:g}){const x=c.useRef(null),k=c.useRef(null),a=c.useRef(null),C=c.useRef(!0),M=c.useRef(!0),P=c.useRef(!1),v=Number(m==null?void 0:m.id)===5,f=c.useMemo(()=>typeof window>"u"||!window.matchMedia?!1:window.matchMedia("(prefers-reduced-motion: reduce)").matches,[]),n=c.useMemo(()=>{const s=Number(m.id)||p+1,i=.0026+s*8e-5,d=.0054+s*14e-5,l=s%2?1:2,h={kx:11+s*2,ky:s%2};return{refreshDelay:v?0:8e3,radiusMini:i,radiusMaxi:d,dHueStep:l,startGroup:h,seed:1337+s*1009,reduceMotion:f}},[v,m.id,p,f]);c.useEffect(()=>{if(!R)return;const s=x.current,i=k.current;if(!s||!i)return;let d=!1,l=null,h=null,w=null;const y=()=>{P.current||(P.current=!0,g==null||g(m.uniqueId))},S=$(async()=>{var I,j;try{const E=await B(()=>import("./embroideryEngine-Bph2I_eq.js"),[]);if(d)return;l=E.createEmbroideryEngine(i,n),a.current=l;const _=()=>z(s,l,window.devicePixelRatio||1);_(),(I=l.renderStatic)==null||I.call(l),M.current&&((j=l.start)==null||j.call(l)),y(),h=new ResizeObserver(()=>{var L;_(),(L=l.renderStatic)==null||L.call(l)}),h.observe(s),"IntersectionObserver"in window&&(w=new IntersectionObserver(L=>{for(const A of L){if(M.current=!!A.isIntersecting,v){M.current||l.stop();continue}M.current&&C.current?l.start():l.stop()}},{threshold:.25}),w.observe(s))}catch{y()}});return()=>{d=!0,S==null||S(),w==null||w.disconnect(),h==null||h.disconnect(),l==null||l.destroy(),a.current=null}},[R,n,m.uniqueId,g]),c.useEffect(()=>{var i,d;const s=a.current;if(s){if(u){(i=s.stop)==null||i.call(s);return}M.current&&((d=s.start)==null||d.call(s))}},[u]),c.useEffect(()=>{var i,d;const s=a.current;if(s){if(u){(i=s.stop)==null||i.call(s);return}M.current&&((d=s.start)==null||d.call(s))}},[u]);const e=()=>{var s;C.current=!0,M.current&&((s=a.current)==null||s.start())},r=()=>{var s,i,d,l;C.current=!0,M.current?(i=(s=a.current)==null?void 0:s.start)==null||i.call(s):(l=(d=a.current)==null?void 0:d.stop)==null||l.call(d)},t=()=>{var s,i,d,l,h,w,y,S,I,j;if(v){(i=(s=a.current)==null?void 0:s.stop)==null||i.call(s),(l=(d=a.current)==null?void 0:d.reset)==null||l.call(d),(w=(h=a.current)==null?void 0:h.start)==null||w.call(h);return}(y=a.current)==null||y.reset(),(I=(S=a.current)==null?void 0:S.renderStatic)==null||I.call(S),M.current&&((j=a.current)==null||j.start())},o=s=>{(s.key==="Enter"||s.key===" ")&&(s.preventDefault(),t())};return b.jsxs("button",{type:"button",ref:x,className:"article-web-art-tile article-web-art-tile-clickable","aria-label":`Web art tile ${p+1}`,disabled:u,onClick:u?void 0:t,onMouseEnter:u||v?void 0:e,onMouseLeave:u||v?void 0:r,onFocus:u||v?void 0:e,onBlur:u||v?void 0:r,onKeyDown:u?void 0:o,children:[b.jsx("canvas",{ref:k,className:"article-web-art-canvas"}),b.jsx("span",{className:"article-web-art-tile-label",children:v?"Click":Number.isFinite(Number(m==null?void 0:m.id))?Number(m.id):p+1})]})}function Ue({itemWrapper:m,index:p,activate:R,onReady:u}){const g=c.useRef(!1),x=c.useRef(null),k=c.useMemo(()=>`<!doctype html>
<html>
<head>
  <meta charset="utf-8">
  <meta name="viewport" content="width=device-width, initial-scale=1">
