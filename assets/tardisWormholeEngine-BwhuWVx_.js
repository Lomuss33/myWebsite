import{a as Pe,s as Fe,P as Ae,W as _e,A as ke,S as Be,q as Ue,k as m,t as We,d as f,u as De,v as q,w as d,x as Ge,G as Ie,D as k,T as se,l as ce,I as Xe,y as ve,z as Ve,J as ue,C as Ye,K as je}from"./three-Cmtw-h9o.js";const Ee=`
varying vec2  vUv;
...
`;function Je(pe,me={}){const de=!!me.reduceMotion;let x=null,s=null,i=null,p=null,U=null,W=null,K=null,D=null,c=[],L=null,N=null,G=null,I=null,O=[],a=null,b=new ue,h=!1,M=null,S=1,C=1,Z=0,J=0,X=0,V=0,T=0,P=0,g=.7,v=.7,Y=0,F=0,j=0,w=0;function xe(){x=new Pe,x.fog=new Fe(0,.0045),s=new Ae(72,1,.1,1e3),s.position.set(0,0,50),i=new _e({canvas:pe,antialias:!0,powerPreference:"high-performance"}),i.toneMapping=ke,i.toneMappingExposure=.88,i.outputColorSpace=Be;const e=new Ue(13,13,260,80,160,!0);e.rotateX(Math.PI/2),e.translate(0,0,-55),p=new m({vertexShader:Ee,fragmentShader:Re,uniforms:{uTime:{value:0},uSpeed:{value:1},uWarpX:{value:0},uWarpY:{value:0},uBurst:{value:0}},side:We}),U=new f(e,p),x.add(U);const n=2600,r=new Float32Array(n*3),u=new Float32Array(n),t=new Float32Array(n),l=new Float32Array(n*3),ae=[[0,.85,1],[1,.15,.72],[.7,.3,1],[1,.75,.25],[.15,1,.75],[1,1,1]];for(let o=0;o<n;o++){const E=3+Math.random()*9.5,R=Math.random()*Math.PI*2;r[o*3+0]=Math.cos(R)*E,r[o*3+1]=Math.sin(R)*E,r[o*3+2]=(Math.random()-.5)*220,u[o]=.3+Math.random()*.9,t[o]=1.5+Math.random()*3.5;const _=ae[Math.floor(Math.random()*ae.length)];l[o*3+0]=_[0],l[o*3+1]=_[1],l[o*3+2]=_[2]}const A=new De;A.setAttribute("position",new q(r,3)),A.setAttribute("aSpeed",new q(u,1)),A.setAttribute("aSize",new q(t,1)),A.setAttribute("aColor",new q(l,3)),W=new m({vertexShader:Ne,fragmentShader:Oe,uniforms:{uTime:{value:0},uSpeed:{value:1}},transparent:!0,blending:d,depthWrite:!1,vertexColors:!0}),x.add(new Ge(A,W)),a=new Ie,a.position.set(0,0,-165),x.add(a);const ne=new m({vertexShader:B,fragmentShader:fe,uniforms:{uTime:{value:0}},side:k});K=new f(new se(9.5,.85,320,32,3,5),ne),a.add(K);const le=new m({vertexShader:B,fragmentShader:fe,uniforms:{uTime:{value:1.2}},side:k,transparent:!0,blending:d,depthWrite:!1,opacity:.45});D=new f(new se(12,.5,260,24,2,7),le),a.add(D);function z(o,E,R,_,Ce){const Te=new m({vertexShader:B,fragmentShader:qe,uniforms:{uTime:{value:0},uColor:{value:new Ye(R)}},transparent:!0,blending:d,depthWrite:!1,side:k}),$=new f(new je(o,E,8,160),Te);return $.rotation.x=_,$.rotation.y=Ce,$}c=[z(14,.1,55551,0,0),z(14,.1,16720072,Math.PI/2,0),z(14,.1,16762930,Math.PI/4,Math.PI/4),z(10.5,.08,6967551,0,Math.PI/3),z(17.5,.07,2162636,Math.PI/3,Math.PI/6),z(17.5,.07,16728160,Math.PI*.6,Math.PI/5)];for(const o of c)a.add(o);L=new m({vertexShader:B,fragmentShader:Ke,uniforms:{uTime:{value:0}},transparent:!0,blending:d,depthWrite:!1,side:k});const ie=new f(new ce(38,38),L);ie.position.z=-1,a.add(ie),G=new f(new Xe(5.5,1),new ve({color:11206655,wireframe:!0,blending:d,depthWrite:!1,transparent:!0,opacity:.5})),a.add(G),I=new f(new Ve(7.5,1),new ve({color:16744703,wireframe:!0,blending:d,depthWrite:!1,transparent:!0,opacity:.35})),a.add(I),N=new m({vertexShader:B,fragmentShader:Le,uniforms:{uTime:{value:0}},transparent:!0,blending:d,depthWrite:!1,side:k});const re=new f(new ce(80,80),N);re.position.z=-4,a.add(re),O=[ne,le,L,N,...c.map(o=>o.material)],b=new ue}function y(){const e=b.getElapsedTime();Math.min(b.getDelta(),.05),w*=.93;const n=g+w;v+=(n-v)*.06,Y*=.93,T+=(X*.012-T)*.08,P+=(V*.012-P)*.08,X*=.85,V*=.85,s.position.x=Z*.15,s.position.y=J*.15;const r=Math.max(0,v-1)*6;s.position.z=50-r+Math.sin(e*.22)*4,s.lookAt(0,0,0);const u=e*1.85+Math.max(0,v-1)*.75;p.uniforms.uTime.value=u,p.uniforms.uSpeed.value=Math.max(.1,v),p.uniforms.uWarpX.value=T,p.uniforms.uWarpY.value=P,p.uniforms.uBurst.value=Y,W.uniforms.uTime.value=e*1.25,W.uniforms.uSpeed.value=Math.max(.1,v),U&&(U.rotation.z=e*.04*v);for(let l=0;l<O.length;l++)O[l].uniforms.uTime.value=u+l*.3;F*=.92,j+=F;const t=.8+v*.5;a.rotation.z=j+e*.08*t,a.rotation.x=Math.sin(e*.14)*(.14+Math.abs(P)*.5),a.rotation.y=Math.cos(e*.1)*(.14+Math.abs(T)*.5),K.rotation.z=e*.28*t,D.rotation.z=-e*.18*t,D.rotation.x=e*.1,G.rotation.x=e*.5*t,G.rotation.y=e*.35,I.rotation.x=-e*.42*t,I.rotation.z=e*.28,c[0].rotation.z=e*.2*t,c[1].rotation.z=-e*.17*t,c[2].rotation.z=e*.13,c[3].rotation.z=-e*.25*t,c[4].rotation.z=e*.09,c[5].rotation.z=-e*.11*t,i.render(x,s)}function ee(){h&&(y(),M=requestAnimationFrame(ee))}function he(e,n,r=1){S=Math.max(1,Math.floor(e||1)),C=Math.max(1,Math.floor(n||1));const u=Math.max(1,Math.min(Number(r)||1,2));s.aspect=S/C,s.updateProjectionMatrix(),i.setPixelRatio(u),i.setSize(S,C,!1),y()}function ge(e,n,r=0,u=0){const t=e*S,l=n*C;Z=(t/S-.5)*14,J=(l/C-.5)*-9,X=r,V=u,h||y()}function oe(){Z=0,J=0}function H(){Y=1.2,g=3.5,window.clearTimeout(H.__timer),H.__timer=window.setTimeout(()=>{g=.7},600)}function Q(){g=-1.5,window.clearTimeout(Q.__timer),Q.__timer=window.setTimeout(()=>{g=.7},700)}function we(e){w+=e,w=Math.max(-2.5,Math.min(4,w))}function ye(e){F=e*.008,j+=F}function ze(){g=.7,v=.7,Y=0,X=0,V=0,T=0,P=0,F=0,j=0,w=0,oe(),h||y()}function be(){y()}function Me(){if(de){y();return}h||(b.start(),h=!0,M=requestAnimationFrame(ee))}function te(){h=!1,M!=null&&cancelAnimationFrame(M),M=null,b.stop()}function Se(){te(),i==null||i.dispose()}return xe(),{start:Me,stop:te,destroy:Se,reset:ze,renderStatic:be,setSize:he,setPointer:ge,clearPointer:oe,boost:H,reverseBurst:Q,addScrollBoost:we,drag:ye}}export{Je as createTardisWormholeEngine};
