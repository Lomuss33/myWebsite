...
export default class ArticleDataWrapper {
    ...
    _parseLocales(rawData, language) {
        ...
        return {
            ...
            complaintYouWhereTitle: language.getTranslation(rawLocales, "complaint_you_where_title", undefined),
            complaintYouWhereBody: language.getTranslation(rawLocales, "complaint_you_where_body", undefined),
            ...
            locationViewLabel: language.getTranslation(rawLocales, "location_view_label", undefined),
            locationVisibleLabel: language.getTranslation(rawLocales, "location_visible_label", undefined),
            locationTomislavgradCountry: language.getTranslation(rawLocales, "location_tomislavgrad_country", undefined),
            locationFrankfurtCountry: language.getTranslation(rawLocales, "location_frankfurt_country", undefined),
            locationTomislavgradVisible: language.getTranslation(rawLocales, "location_tomislavgrad_visible", undefined),
            locationFrankfurtVisible: language.getTranslation(rawLocales, "location_frankfurt_visible", undefined),
            locationZoomOutLabel: language.getTranslation(rawLocales, "location_zoom_out_label", undefined),
            locationZoomInLabel: language.getTranslation(rawLocales, "location_zoom_in_label", undefined),
            locationPresetsLabel: language.getTranslation(rawLocales, "location_presets_label", undefined),
            locationPresetStreetLabel: language.getTranslation(rawLocales, "location_preset_street_label", undefined),
            locationPresetCityLabel: language.getTranslation(rawLocales, "location_preset_city_label", undefined),
            locationPresetRegionLabel: language.getTranslation(rawLocales, "location_preset_region_label", undefined),
            locationPanLinkLabel: language.getTranslation(rawLocales, "location_pan_link_label", undefined),
            locationPanLinkedLabel: language.getTranslation(rawLocales, "location_pan_linked_label", undefined),
            locationChooseLabel: language.getTranslation(rawLocales, "location_choose_label", undefined),
            locationBalkanMenuLabel: language.getTranslation(rawLocales, "location_balkan_menu_label", undefined),
            locationGermanyMenuLabel: language.getTranslation(rawLocales, "location_germany_menu_label", undefined),
            locationPlacesLabel: language.getTranslation(rawLocales, "location_places_label", undefined),
            locationCountryBih: language.getTranslation(rawLocales, "location_country_bih", undefined),
            locationCountryCroatia: language.getTranslation(rawLocales, "location_country_croatia", undefined),
            locationCountrySerbia: language.getTranslation(rawLocales, "location_country_serbia", undefined),
            locationCountryGermany: language.getTranslation(rawLocales, "location_country_germany", undefined),
