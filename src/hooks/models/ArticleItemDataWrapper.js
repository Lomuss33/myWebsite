...
export default class ArticleItemDataWrapper {
    ...
    _parseLink(rawLink, language) {
        ...
        return {
            ...
            tooltip: tooltipString ?
                language.getStringOrFallback(tooltipString, language.parseJsonText(tooltipString)) :
                null
        }
    }
    ...
    _parseLocales(locales, language) {
        ...
        const translations = {
            ...
            axisStart: language.getTranslation(locales, "axis_start", null),
            axisEnd: language.getTranslation(locales, "axis_end", null),
